...
public class x867B {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (System.getProperty("ONLINE_JUDGE") == null && !ONLINE_JUDGE) {
                FileOutputStream output = new FileOutputStream("src/Codeforces/Contests/output.txt");
                PrintStream out = new PrintStream(output);
                System.setOut(out);
 
                InputStream input = new FileInputStream("src/Codeforces/Contests/input.txt");
                System.setIn(input);
            }
    ...
    static void solve(int n,long[] nums){
        ...
        if(p1>0 && p2>0 && n1<0 && n2<0){
            mul1=(long)p1*(long)p2;  
            mul2=(long)n1*(long)n2;
            if(mul1>mul2){
               out.println(mul1);
               }
               else
