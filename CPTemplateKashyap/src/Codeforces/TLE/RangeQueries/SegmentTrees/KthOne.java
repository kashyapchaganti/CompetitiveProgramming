...
public class KthOne {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(m-->0){
                ...
                if(x==1){
                    sg.update(0, 0, n-1, (int)y);
                }else{
                    out.println(sg.query(0,0,n-1,y));
    ...
    static class SGT{
        ...
        public void update(int idx, int i, int j, int idx1){
            if(i==j){
                if(arr[idx]==1){
                    arr[idx]=0;
                }else{
            ...
            int mid = (i+j)/2;
            if(mid<idx1){
                update(2*idx+2,mid+1,j,idx1);
                
            }else{
                update(2*idx+1,i,mid,idx1);
            }
            arr[idx]= operation(arr[2*idx+1],arr[2*idx+2]);
        }
        public long query(int idx, int i, int j, long k){
            if(k==0 && i==j){
                return i;
            }
            int mid= i+(j-i)/2;
            ...
            long y= arr[2*idx+2];
            if(k+1<=x){
                return query(2*idx+1,i,mid,k);
            }else{
                return query(2*idx+2,mid+1,j,k-x);
            }
