...
public class MulSum {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(m-->0){
                ...
                int z= sc.nextInt(); 
                long v = sc.nextLong(); 
                    sg.update(0, 0, n-1, y, z-1,v);
                }else{
                    int y= sc.nextInt();
                int z= sc.nextInt(); 
                
                    out.println(sg.query(0,0,n-1,y,z-1));
    ...
    static class SGT{
        ...
        public void update(int idx, int i, int j, int l, int r, long val){
            ...
            if(lazy[idx]!=0){
                arr[idx]=(arr[idx]*(lazy[idx])%mod)%mod;
                if(i!=j){
            ...
            if(l<=i && r>= j){
                arr[idx]=(arr[idx]*(val)%mod)%mod;
                if(i!=j){
                    lazy[2*idx+1]= (lazy[2*idx+1]*val)%mod;
                    lazy[2*idx+2]= (lazy[2*idx+2]*val)%mod;
                }
                return;
