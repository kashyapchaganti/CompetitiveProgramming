...
public class x380C {
        ...
        try {
            ...
            while(m-->0){
                ...
                int z= sc.nextInt();    
                    ...
                    out.println((sg.query(0,0,n-1,y-1,z-1).full)*2);
    ...
    static class SGT{
        ...
        public void build(int idx, int i, int j,char[] nums ){
            if(i==j){
                if(nums[i]=='('){
                    arr[idx]=new Pair(1,0,0);
                }else{
                    arr[idx]=new Pair(0,1,0);
                }
                return;
            }
            int mid = (i+j)/2;
    ...
    static Pair operation(Pair a, Pair b){
        int f = a.full + b.full + Math.min(a.open, b.close);
        int o = a.open + b.open -Math.min(a.open, b.close);
        int c= a.close + b.close -Math.min(a.open, b.close);
    ...
    static class Pair{
        ...
        int close;
        int full;
        public Pair(int open, int close, int full){
            this.open=open;
            this.close=close;
            this.full= full;
        }
