...
class StringMatching {
    ...
    static int itr;
    static int md = 32768;
    static long mod = (long)(1012346665879L);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            long h1 =getHash(s1,m);
            long h2 =getHash(s2,m);
            ...
            for(int i=1,j=m;i<n && j<n;i++,j++){ // sliding window // Rabin Karp
                long del = ((s1.charAt(i-1)-'a'+1)*p)%mod;
                h1 = (h1-del+mod)%mod;
                h1=(h1*37)%mod;
                //out.println(s1.charAt(j));
                long add= s1.charAt(j)-'a'+1;
                h1=(h1+add)%mod;
                if(h1==h2){
                    c++;
                }
