...
class TreeDiameter {
    ...
    static void check(int i, int p, List<List<Integer>> adj, int[] outDp, int[]inDp){
        ...
        maxi=Math.max(maxi,Math.max(inDp[i],outDp[i]));
        return;
    }
