...
public class FD1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (System.getProperty("ONLINE_JUDGE") == null && !ONLINE_JUDGE) {
                FileOutputStream output = new FileOutputStream("/Users/kashyapchaganti/Documents/Code/CompetitiveProgramming/CPTemplateKashyap/src/CSES/Graphs/output.txt");
                PrintStream out = new PrintStream(output);
                System.setOut(out);
 
                InputStream input = new FileInputStream("/Users/kashyapchaganti/Documents/Code/CompetitiveProgramming/CPTemplateKashyap/src/CSES/Graphs/input.txt");
                System.setIn(input);
            }
    ...
    class Pair{
        ...
        public Pair(int r, long c, int d){
            this.r=r;
            this.c=c;
            this.d=d;
        }
