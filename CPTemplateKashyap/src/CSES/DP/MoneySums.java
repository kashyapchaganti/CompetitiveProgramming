...
class MoneySums {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Boolean [][] dp = new Boolean [n+1][(int)(1e5+2)];
    ...
    static boolean check(Boolean[][] dp, int i, int s, int[] nums, int n ){
        if(i==n && s==0){
            return true;
        }
        if(i>=n || s<0){
        ...
        boolean a = check(dp,i+1,s-nums[i],nums,n);
        boolean b = check(dp,i+1,s,nums,n);
        return dp[i][s]=a || b;
    }
